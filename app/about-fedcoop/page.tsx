        ...
        <div className='w-full max-w-6xl mx-auto'>
          <motion.div
            ...
            <p className='text-xl text-muted-foreground max-w-3xl mx-auto'>
              ...
              Cooperative Societies in Federal Government Ministries,
            ...
            <motion.div
              ...
              <div className='space-y-4 text-muted-foreground'>
                <p>
                  ...
                  accountability, and in alignment with cooperative principles
                  and values.
                </p>
                <p>
                  Through our unified approach, we foster collaboration,
                  knowledge sharing, and collective investment opportunities
                  that benefit all members and contribute to Nigeria&apos;s
